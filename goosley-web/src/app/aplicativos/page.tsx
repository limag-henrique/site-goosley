      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-2xl text-foreground/80 mb-12 leading-relaxed">
            Transformamos a essência da sua marca em experiências digitais nativas. Desenvolvemos aplicativos de forma ágil, entregando interfaces modernas, intuitivas e perfeitamente alinhadas aos seus objetivos de negócio.
          </p>
          ...
          <div className="pt-12 border-t border-foreground/10 flex flex-wrap gap-4">
            ...
            <Link 
              href="/precos?categoria=aplicativos" 
