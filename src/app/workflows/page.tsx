      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 leading-tight">
            Workflows de Back-Office Autônomos
          </h1>
          <p className="text-2xl text-foreground/80 mb-12 leading-relaxed">
            Liberte sua equipe de tarefas repetitivas. Desenvolvemos fluxos inteligentes integrados ao seu CRM ou ERP para executar rotinas complexas, como triagem de e-mails, extração de dados de faturas e categorização automática de informações.
          </p>
          ...
          <div className="pt-12 border-t border-foreground/10 flex flex-wrap gap-4">
            ...
            <Link 
              href="/precos?categoria=workflows" 
